...
[Cloudflare Tunnel](ingress-cloudflare-tunnel.md) option instead. It trades the open ports for a
different requirement: the domain has to be managed in Cloudflare, either registered there or
