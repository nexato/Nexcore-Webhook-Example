...
This is a **low-code alternative** to receive and download the exported files from the webhooks. 
You "click together" a **Microsoft Power Automate** cloud flow that downloads the exported files 
from a nexcore
